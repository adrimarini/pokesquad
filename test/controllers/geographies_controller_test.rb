...
class GeographiesControllerTest < ActionController::TestCase
  ...
  test "should create geography" do
    assert_difference('Geography.count') do
      post :create, geography: { city: @geography.city, neighborhood: @geography.neighborhood, state: @geography.state }
    end
  ...
  test "should update geography" do
    patch :update, id: @geography, geography: { city: @geography.city, neighborhood: @geography.neighborhood, state: @geography.state }
    assert_redirected_to geography_path(assigns(:geography))
  end
